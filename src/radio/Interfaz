...
// con esto de alguna manera para apagar el radio y encenderlo
			...
			if(mouse.getSource() == bGuardar){
				...
				int entero = Integer.parseInt(num);
                                String doble = lEstacion.getText();
                                double dDoble = Double.parseDouble(doble);
                                radio.guardar((int)entero,(double) dDoble);
